<?php
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM feedback ORDER BY id DESC");

?>
<html>
<head>
    <title>MMI | Feedback</title>
...
<div class= "header">
        <header>
            ...
            <nav>
                ...
                <ul>
                    <div class="pages">
                        <li id="pages"><a href="Admin.php"><i class="fa fa-user-lock"></i> Admin Panel</a></li>
                        <li id="pages"><a href="Feedback.php" class="active"><i class="fa fa-comment"></i> Feedback</a></li>
                    </div>
                </ul>
            </form>
            </nav>
            ...
            <div id="menu" class="nav-2">
              ...
              <a href="Admin.php" ><i class="fa fa-user-lock"></i> Admin Panel</a>
              <a href="Feedback.php"style="background: -webkit-linear-gradient(rgb(255, 255, 255), rgba(255, 255, 255), rgba(255, 255, 255),  rgb(0, 0, 0));
              -webkit-background-clip: text;
              -webkit-text-fill-color: transparent;"><i class="fa fa-comment"></i> Feedback</a>
            </div>
    </div>
    <br>
    <br>
...
<center>
	...
	<tr>
		<th>Name</th>
		<th style="max-width: 300px;">Feedback</th>
		<th>Picture Proof Link</th>
		<th>Update</th>
	</tr>
	<?php 
	...
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr>";
		echo "<td>".$res['name']."</td>";
		echo "<td style='max-width: 300px;'>".$res['fb']."</td>";
		echo "<td>".$res['pic_name']."</td>";
		echo "<td><a href=\"<a href=\"Feedback/delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
</div>
